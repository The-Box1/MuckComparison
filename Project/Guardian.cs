...
public class Guardian : MonoBehaviour
{
	...
	public static Color TypeToColor(GuardianType t)
	{
		return t switch
		{
			GuardianType.Basic => Color.white, 
			GuardianType.Red => Color.red, 
			GuardianType.Yellow => Color.yellow, 
			GuardianType.Green => Color.green, 
			GuardianType.Blue => Color.blue, 
			GuardianType.Pink => Color.magenta, 
			_ => Color.white, 
		};
	}
}
